...
namespace AutoScheduler.DataAccess.Migrations
{
    ...
    [Migration("20260617053905_TimesheetRequirementsM2M")]
    partial class TimesheetRequirementsM2M
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoScheduler.Domain.Entities.Timesheets.Timesheet", b =>
                {
                    ...
                    b.Property<TimeOnly>("GeneralBreakEnd")
                        .HasColumnType("time");

                    b.Property<TimeOnly>("GeneralBreakStart")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("AutoScheduler.Domain.Entities.Timesheets.TimesheetActivityRequirements", b =>
                {
                    ...
                    b.HasKey("TimesheetId", "ActivityRequirementsId");

                    b.HasIndex("ActivityRequirementsId");

                    b.ToTable("TimesheetActivityRequirements");
                });
            ...
            modelBuilder.Entity("AutoScheduler.Domain.Entities.Timesheets.TimesheetActivityRequirements", b =>
                {
                    b.HasOne("AutoScheduler.Domain.Entities.Activities.ActivityRequirements", "Requirements")
                        .WithMany("TimesheetRequirements")
                        .HasForeignKey("ActivityRequirementsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutoScheduler.Domain.Entities.Timesheets.Timesheet", "Timesheet")
                        .WithMany("TimesheetActivityRequirements")
            ...
            modelBuilder.Entity("AutoScheduler.Domain.Entities.Activities.ActivityRequirements", b =>
                {
                    ...
                    b.Navigation("TimesheetRequirements");
                });
            ...
            modelBuilder.Entity("AutoScheduler.Domain.Entities.Timesheets.Timesheet", b =>
                {
                    b.Navigation("TimesheetActivityRequirements");
