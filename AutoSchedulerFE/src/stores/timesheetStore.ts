...
import type { GeneratorRequirements, Timesheet, TimesheetViewRequirements, Timeslot, TimeslotPlacementChange, WeekdayTimeRange } from '@/classes/timesheet';
...
export const useTimesheetStore = defineStore('timesheet', () => {
  ...
  const availableRanges:Ref<WeekdayTimeRange[]> = ref([]);
  ...
  async function getAvailableSpaceForTimeslot(timeslotPlacementChange:TimeslotPlacementChange){
    ...
    availableRanges.value = timeranges;
  }
